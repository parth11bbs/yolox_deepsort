...
# Creating list for all the lines
lines = [
    {'Title': 'Line1', 'Coordinate': [(580, 500), (100, 500)]},
    {'Title': 'Line2', 'Coordinate': [(680, 500), ((1070, 500))]}
]
...
def draw_lines(lines, img):
    for line in lines:
        img = cv2.line(img, line['Coordinate'][0], line['Coordinate'][1], (255, 255, 255), 3)
        return img
